...
This service lets you self-host the [sticker-repo](https://sticker-repo.github.io) repository. On first startup, it clones all sticker packs, then mimics the Matrix homeserver federation API to serve them to your homeserver as needed.
